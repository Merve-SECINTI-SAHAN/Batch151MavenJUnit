...
public class C02_Dropdown {
   ...
   8- dropdown menüye sendKeys() methodu ile de dropdown menüdeki seçeneklerden birini kullanarak gönderebiliriz
     */
 ...
 */
    ...
    public void test01() {
        ...
        //        c. Select object i kullaarak 3 farkli sekilde secim yapiniz
        select.selectByIndex(5); //index, 0'dan başlar ve 2018i seçer
    ...
    public void test03() {
        ...
        Assert.assertTrue(seciliOlanSecenek.contains("Select a State"));
    }
