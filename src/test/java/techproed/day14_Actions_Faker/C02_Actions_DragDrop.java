...
public class C02_Actions_DragDrop extends TestBase {
    ...
    public void test01() {
        ...
        sürüklemek istediğimiz webelementin locatini alıp üzerine bırakacağımız webelementin locatini de alarak
        drogAndDrop(kaynak,hedef) methodu ile işlemi gerçekleştirebiliriz.
         */
    ...
    public void test02() {
        ...
        actions.clickAndHold(drag). //--> Bu method ile webelemente mouse ile basılı tuttuk
               moveToElement(drop). //--> Bu method ile basılı tuttuğumuz webelementi diğer webelementin üzerine götürdük
