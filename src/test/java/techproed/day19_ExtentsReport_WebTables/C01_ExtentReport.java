...
public class C01_ExtentReport extends TestBase {
    ...
    public void test01() {
        ...
        extentReports.setSystemInfo("Browsser", "Chrome");
     ...
     */
        ...
        extentTest.pass("Sonuç yazısı konola yazdırıldı");
        extentTest.pass("Sayfa kapatıldı");

        /*
         extentTest objesi ile info() methodunu kullanarak her stepte ne yaptigimizla alakali bilgi yazabiliriz
