...
public class C01_ReadExcel {
    ...
    public void readExcel() throws IOException {
        ...
        for (int i = 0; i < workbook.getSheet("Sheet1").getPhysicalNumberOfRows(); i++) {//satır sayısı 11
            for (int j = 0; j < workbook.getSheet("Sheet1").getRow(0).getPhysicalNumberOfCells(); j++) { //sütun sayısı 2
